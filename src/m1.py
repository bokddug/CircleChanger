...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.circle.fill_color1 = fill_color
    ...
    def get_distance_from(self, point):
        ...
        return start.get_distance_from(point)
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        for k in range(times_to_swell_or_shrink):
            ...
            self.draw()
            self.swell_or_shrink_once(amount_to_swell_or_shrink-2*amount_to_swell_or_shrink)
            self.draw()
    def swallow(self, other_circle_changer):
        ...
        center= rg.Point((p1.x+p2.x)/2,(p1.y+p2.y)/2)
        r=self.circle.center.get_distance_from(other_circle_changer.circle.center)/2
        circle= rg.Circle(center,r)
        circle.fill_color = 'red'
        circle.color = self.colors+other_circle_changer.colors

        return CircleChanger(circle.center.x,circle.center.y,circle.radius,'red', circle.color)
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color =self.circle.fill_color1
    ...
    def change_to_next_color_in_tuple(self):
        ...
        current = self.count %len(self.colors)
